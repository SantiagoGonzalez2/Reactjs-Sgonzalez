 ...
 const alert = () =>{
  ...
  return (
    <div id="contador">
      ...
      <button className="btn btn-dark" id='button'  onClick={() =>{ onAdd(quantity); setButtonText("Elemento agregado,vacie el carro para volver a agregar"); alert() }}>{buttonText}</button>
